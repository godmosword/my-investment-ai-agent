...
| **4c** BQ `profile` | ✅ | [`bigquery_writer.py`](../../bigquery_writer.py)、[`bq_brief_profile_columns.sql`](../SQL/bq_brief_profile_columns.sql) | 2026-04-16 |
...
| 租戶級 layout | 需產品決策 |
| 雙訊息／`DAILY_BRIEF_V2` Phase C | 見 [`DAILY_BRIEF_V2.md`](../DAILY_BRIEF_V2.md) |
...
| [`DAILY_BRIEF_V2.md`](../DAILY_BRIEF_V2.md) | 區塊順序與寫作契約 |
