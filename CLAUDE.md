...
- [`docs/architecture/`](docs/architecture/)（`AI_CONTEXT.md`、`REVIEWER_LOOP_DESIGN.md`、`TERMINAL_FRONTEND_PLAN.md` 等）；**架構目錄判讀**以 [`Terminal_Master_Plan.md`](docs/architecture/Terminal_Master_Plan.md) **§0 狀態矩陣 + Phase 0／Phase 1** 為準（研究稿非預設產品承諾，事實以 `CHANGELOG.md`／程式為準；**Phase 1** staging 執行稿見 [`STAGING_CURRENT_AFFAIRS_SMOKE.md`](docs/STAGING_CURRENT_AFFAIRS_SMOKE.md)）
