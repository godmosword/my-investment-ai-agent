...
| [`earnings_watchlist.py`](earnings_watchlist.py) | 美股 mega-cap／AI 財報 watchlist 與錨定週邏輯（`macro_context`、財報聚焦、週末預告共用） |
| [`earnings_focus.py`](earnings_focus.py) | 可選 **`EARNINGS_FOCUS_MODE`**；週末自動【下週財報預告】exclusion |
