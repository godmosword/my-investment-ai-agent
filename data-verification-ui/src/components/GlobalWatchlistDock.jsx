...
export default function GlobalWatchlistDock() {
  ...
  return (
    <div className="fixed bottom-[72px] right-3 z-40 md:bottom-4">
      {open ? (
        <div
      ...
      <button
        ...
        className="min-h-[44px] rounded-full border border-cyan-300/40 bg-cyan-500/15 px-4 py-2 text-[13px] font-semibold text-cyan-100 shadow-xl backdrop-blur hover:bg-cyan-500/25"
