...
- **Gemini model** (`gemini/gemini-3.1-pro-preview` in `crew.py`) — this is a valid model per [Google AI docs](https://ai.google.dev/gemini-api/docs/models/gemini-3.1-pro-preview).
