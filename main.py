...
tasks = [
    ...
    Task(
        ...
        標題：【Qingpu Silicon Brain | 每日加密貨幣戰報 - {TODAY}】
        
        內容結構：
        1. 🚦 **今日信號**：(極度恐懼/中性/貪婪)
        2. ⚔️ **大腦對決**：
           - 🐂 **Grok 激進看多**：一句話利多 + 2 個支撐點。
           - 🐻 **Gemini 冷酷風險**：一句話風險 + 1 個預警。
        3. 📊 **籌碼雷達**：將 CoinGlass 數據轉化為白話建議。
        4. 🖋️ **矽大腦筆記**：以半導體工程師視角給出一句市場洞察。
        
        最後附註：『⚠️ 本報告由 AI 智庫生成。想要更深度的產業分析？請點擊下方按鈕訂閱。』
        """,
        agent=risk_auditor,
