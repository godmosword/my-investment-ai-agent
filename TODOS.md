...
> **2026-04-14 進度備註（非 exhaustive）**：T1a／T1b／T1c、T2a／T2b／T2c、T3a／T3b／T3c 已有**可 review 初版**（見上「已交付摘要」列與 CHANGELOG）；T4a／T4b **實作**仍待合規拍板（T4b 目前為 `docs/PWA_WEB_PUSH.md` 草案）；跨來源 BQ vs yfinance **實盤** E2E 仍屬 Bloomberg 條目 6 缺口。
