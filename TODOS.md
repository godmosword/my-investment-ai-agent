...
| 主題 | 代表檔案／行為 |
|------|----------------|
| **PWA 視覺化 V1**（Design Foundation） | [`visualization_plan.md`](visualization_plan.md) Phase **V1**；[`data-verification-ui/src/design/tokens.js`](data-verification-ui/src/design/tokens.js)、[`tailwind.config.js`](data-verification-ui/tailwind.config.js)、[`components/common/`](data-verification-ui/src/components/common/)（`AsOfChip`、`ProvenancePopover`、…）、dev **`/design`**；[`Today.jsx`](data-verification-ui/src/pages/Today.jsx)／[`TerminalSymbolCard.jsx`](data-verification-ui/src/components/TerminalSymbolCard.jsx) 已接入；CHANGELOG **2026-04-18**；契約 [`docs/DASHBOARD_CONTRACT.md`](docs/DASHBOARD_CONTRACT.md)「PWA 設計 tokens」。 |
| **PWA 視覺化 V2**（結構化 Report — 首批） | `GET /api/reports/{date}/structured`（[`api.py`](api.py)）、[`test_report_structured_api.py`](test_report_structured_api.py)；PWA **`VITE_STRUCTURED_REPORT`**、[`StructuredReportView`](data-verification-ui/src/components/report/StructuredReportView.jsx)、[`legacyBlockContent.js`](data-verification-ui/src/components/report/legacyBlockContent.js)；CHANGELOG **2026-04-18**。**尚未**：BQ／scratchpad 持續 **`daily_brief_report`** JSON、逐區塊真實元件與 **gate_summary** 富化（見 [`visualization_plan.md`](visualization_plan.md) V2）。 |
