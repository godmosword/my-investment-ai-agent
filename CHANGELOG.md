...
- **Workspace import/export**：新增 [`WorkspacePanel.jsx`](data-verification-ui/src/components/WorkspacePanel.jsx) 並掛入 shared monitor，支援 localStorage workspace layout、watchlist/recent symbols 匯出與 JSON 匯入，作為 Queue 34 local-first workspace v1。
